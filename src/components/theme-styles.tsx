function hexToOklch(hex: string): string {
  ...
  const b_val = 0.0259040371 * l_cuberoot + 0.7827717662 * m_cuberoot - 0.808675766 * s_cuberoot;
...
export async function ThemeStyles() {
  ...
  const cssVariables = `
    ...
    .bg-gradient-primary { background: linear-gradient(135deg, var(--theme-primary), var(--theme-primary-dark)); }
    .bg-gradient-secondary { background: linear-gradient(135deg, var(--theme-secondary), var(--theme-secondary-dark)); }
    .bg-gradient-accent { background: linear-gradient(135deg, var(--theme-accent), var(--theme-accent-dark)); }
    .bg-gradient-primary-accent { background: linear-gradient(135deg, var(--theme-primary), var(--theme-accent)); }
    .bg-gradient-primary-secondary { background: linear-gradient(135deg, var(--theme-primary), var(--theme-secondary)); }
    .bg-gradient-secondary-accent { background: linear-gradient(135deg, var(--theme-secondary), var(--theme-accent)); }
    .bg-gradient-hero { background: linear-gradient(135deg, var(--theme-primary) 0%, var(--theme-accent) 50%, var(--theme-secondary) 100%); }
    .bg-gradient-hero-subtle { background: linear-gradient(135deg, var(--theme-primary)/10 0%, var(--theme-accent)/5 50%, var(--theme-secondary)/10 100%); }
    .bg-radial-primary { background: radial-gradient(circle at center, var(--theme-primary), var(--theme-primary-dark)); }
    .bg-radial-accent { background: radial-gradient(circle at center, var(--theme-accent), var(--theme-accent-dark)); }
  `;
